...
public class Item_Gases extends Item{
	...
	public Item_Gases(int id) {
		super(id);
		//setHasSubtypes(true);
		setUnlocalizedName("fcItem_Gases");
		setMaxDamage(0); 
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
    	...
    	for (int i=0;i<itemsData.size();i++){
    		Icons[i]=par1IconRegister.registerIcon("FrogCraft:Gases/"+itemsData.get(i)[0]);

    		LiquidStack l=LiquidDictionary.getCanonicalLiquid(new LiquidStack(itemID, 1000, i)).setRenderingIcon(Icons[i]).setTextureSheet("/gui/items.png");
    	}
    }
