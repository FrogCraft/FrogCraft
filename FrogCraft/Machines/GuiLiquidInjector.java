...
public class GuiLiquidInjector extends GuiLiquids {
	protected TileEntityLiquidInjector te;

	
    public GuiLiquidInjector (InventoryPlayer inventoryPlayer,TileEntityLiquidInjector tileEntity) {
    	super(new ContainerLiquidInjector(inventoryPlayer,tileEntity));
    	te=tileEntity;
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
    	...
    	this.drawLiquidBar(143, 23, 16, 47, te.idIn, te.damageIn, te.amountInP/10);
