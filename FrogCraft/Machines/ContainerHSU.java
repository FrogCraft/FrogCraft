...
public class ContainerHSU extends Container {

	protected TileEntityHSU tileEntity;
	
	public int energyK=0,energyM=0,energyB=0;
	
	public ContainerHSU (InventoryPlayer inventoryPlayer, TileEntityHSU te){
        tileEntity = te;

        addSlotToContainer(new Slot(tileEntity, 0, 113, 24));
        addSlotToContainer(new Slot(tileEntity, 1, 113, 42));
