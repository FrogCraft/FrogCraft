...
public class ContainerCombustionFurnace extends Container {
	...
	public ContainerCombustionFurnace (InventoryPlayer inventoryPlayer, TileEntityCombustionFurnace te){
        tileEntity = te;

        //Input side
        addSlotToContainer(new FuelSlot(tileEntity, 0, 24, 28));
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int slot) {
            ...
            if (slotObject != null && slotObject.getHasStack()) {
                    ...
                    //places it into the tileEntity is possible since its in the player inventory
                    	...
                    	else if (!this.mergeItemStack(stackInSlot, 2,3, false)) 
                            return null;
                    }
