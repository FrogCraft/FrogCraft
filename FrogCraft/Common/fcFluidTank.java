 ...
 * 
 */
public class fcFluidTank implements IFluidTank
{
    public FluidStack fluid;
    protected int capacity;
    protected TileEntity tile;

    public fcFluidTank(int capacity)
    {
        this(null, capacity);
    }

    public fcFluidTank(FluidStack stack, int capacity)
    {
        this.fluid = stack;
        this.capacity = capacity;
    }

    public fcFluidTank(Fluid fluid, int amount, int capacity)
    {
        this(new FluidStack(fluid, amount), capacity);
    }

    public fcFluidTank readFromNBT(NBTTagCompound nbt)
    {
        if (!nbt.hasKey("Empty"))
        {
